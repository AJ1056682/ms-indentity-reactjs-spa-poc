...
import { DossierData } from "../components/DataDisplay";
...
const DossierContent = () => {
    ...
    useEffect(() => {
        if (account && inProgress === "none" && !dossierData) {
            instance.acquireTokenSilent({
                scopes: protectedResources.apiDossiers.scopes,
                account: account
            }).then((response) => {
                callApiWithToken(response.accessToken, protectedResources.apiDossiers.endpoint)
                    .then(response => setDossierData(response));
            }).catch((error) => {
